...
with open(r"euee_notes\physics\notes.md", "r", encoding="utf-8") as f:
    md_text = f.read()
...
with open("Dr_Abebe_Physics_Ultimate_Guide.pdf", "w+b") as out:
    pisa.CreatePDF(full_html, dest=out)
    
print("PDF generated successfully as Dr_Abebe_Physics_Ultimate_Guide.pdf")
