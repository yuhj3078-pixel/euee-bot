-- ============================================================================
-- LEGACY / ALTERNATIVE SUPABASE SCHEMA FOR ABEBE EUEE BOT
-- Do NOT run this after supabase_schema.sql on an existing project.
-- Use supabase_schema.sql as the primary schema for new deployments.
