-- ============================================================================
-- WORKING SUPABASE SCHEMA FOR ABEBE EUEE BOT
...
ADD CONSTRAINT fk_payment_attempts_telegram_id 
...
ALTER TABLE tier_change_log 
ADD CONSTRAINT fk_tier_change_log_telegram_id 
FOREIGN KEY (telegram_id) REFERENCES users(telegram_id) ON DELETE CASCADE;
...
ADD CONSTRAINT fk_wrong_questions_telegram_id 
FOREIGN KEY (telegram_id) REFERENCES users(telegram_id) ON DELETE CASCADE;
...
ALTER TABLE battles 
ADD CONSTRAINT fk_battles_challenger_id 
FOREIGN KEY (challenger_id) REFERENCES users(telegram_id) ON DELETE CASCADE;

ALTER TABLE battles 
ADD CONSTRAINT fk_battles_opponent_id 
...
-- Add foreign key constraint
ALTER TABLE exams 
ADD CONSTRAINT fk_exams_telegram_id 
FOREIGN KEY (telegram_id) REFERENCES users(telegram_id) ON DELETE CASCADE;
...
ADD CONSTRAINT fk_parent_reports_telegram_id 
FOREIGN KEY (telegram_id) REFERENCES users(telegram_id) ON DELETE CASCADE;
...
ADD CONSTRAINT fk_feature_suggestions_telegram_id 
FOREIGN KEY (telegram_id) REFERENCES users(telegram_id) ON DELETE CASCADE;
...
BEGIN
    ...
    RAISE NOTICE '🚀 All foreign key constraints added properly!';
END $$;
